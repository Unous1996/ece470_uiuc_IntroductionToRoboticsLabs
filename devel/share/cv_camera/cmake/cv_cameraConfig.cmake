...
if("TRUE" STREQUAL "TRUE")
  set(cv_camera_SOURCE_PREFIX /home/ur3/catkin_aol3/src/drivers/cv_camera)
  set(cv_camera_DEVEL_PREFIX /home/ur3/catkin_aol3/devel)
  ...
  set(cv_camera_INSTALL_PREFIX /home/ur3/catkin_aol3/install)
...
if(NOT "/home/ur3/catkin_aol3/src/drivers/cv_camera/include " STREQUAL " ")
  set(cv_camera_INCLUDE_DIRS "")
  set(_include_dirs "/home/ur3/catkin_aol3/src/drivers/cv_camera/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'cv_camera' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ur3/catkin_aol3/src/drivers/cv_camera/${idir}'.  ${_report}")
    endif()
